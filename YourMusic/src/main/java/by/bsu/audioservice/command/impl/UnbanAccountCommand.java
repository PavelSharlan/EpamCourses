...
public class UnbanAccountCommand implements Command {
    ...
    /** Field LOGGER */
    private static final Logger LOGGER = LogManager.getLogger(UnbanAccountCommand.class);
    ...
    public String execute(HttpServletRequest request) {
        LOGGER.info("Unban account command");
        String page = null;
        try {
            Long accountId = Long.parseLong(request.getParameter(ACCOUNT_ID));
            BanAccountLogic.unban(accountId);
